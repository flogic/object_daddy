  ...
  module ClassMethods
    ...
    def generate(args = {})
      ...
      if @presence_validated_attributes
        ...
        missing = reflect_on_all_associations.to_a.select {|a| a.macro == :belongs_to }.select {|a| req[a.name] or req[a.primary_key_name] } # limit to those which are belongs_to associations
